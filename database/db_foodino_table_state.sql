...
CREATE TABLE `table_state` (
  ...
  PRIMARY KEY (`id`),
  KEY `table_state_country_id_96d42763_fk_table_country_id` (`country_id`),
  CONSTRAINT `table_state_country_id_96d42763_fk_table_country_id` FOREIGN KEY (`country_id`) REFERENCES `table_country` (`id`)
...
LOCK TABLES `table_state` WRITE;
/*!40000 ALTER TABLE `table_state` DISABLE KEYS */;
INSERT INTO `table_state` VALUES (1,'البرز',6,1),(2,'البرز',6,1),(3,'تهران',6,1);
